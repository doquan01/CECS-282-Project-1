...
Faculty *f2 = new Faculty("Bouris","William","791", F, "3/14/75", AO, "Ph.D", "English", 1);
f2->putData();

Faculty *f3 = new Faculty("Andrade","Christopher","623", F, "5/22/80", AS, "MS", "Physical Education", 0);
f3->putData();
